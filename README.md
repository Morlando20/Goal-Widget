...
Open `index.html` in a browser or embed it in your streaming software as a browser source. The widget is responsive and scales with the size of the browser source.
